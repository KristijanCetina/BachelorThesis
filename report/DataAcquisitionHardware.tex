...
Na samoj tiskanoj pločici postoji takozvano prototipno područje za dodavanje vanjskih elemanata čiji je raster 2.54 mm koji odgovara standardu \textit{true-hole} elemenata.
...
Iako je softwareski fiter u nekim situacijama dovoljno dobar, ovo jednostavno i jeftino rješenje daje dodatni sloj filtriranja koji za posljedicu ima vrlo glatko očitanje temperature bez skokova u vrijednostima.
